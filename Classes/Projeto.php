			...
			foreach($id_investidores as $id_investidor){
				...
				$investidores=$selecionar->fetchAll(PDO::FETCH_OBJ);
				  foreach($investidores as $investidor){
					 $inves=new Investidor($investidor->nome,$investidor->email,$investidor->login,$investidor->senha,$investidor->localizacao,$investidor->telefone,$investidor->outrosmeiosdecontato,$investidor->areaatuacao,$investidor->disponibilidade,$investidor->orcamentoinvestido,$investidor->imagem,$investidor->idinvestidor);
