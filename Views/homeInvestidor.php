  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-dark border-right text-light" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="cadastroProjeto.php" class="list-group-item list-group-item-action bg-dark text-light"><i class="fas fa-user-friends"></i> Parcerias</a>
        <a href="#" class=" mys-projects list-group-item list-group-item-action bg-dark text-light"><i class="fas fa-project-diagram"></i> Projetos investidos</a>
