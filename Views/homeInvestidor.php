  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right " id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        ...
        <a href="#" class=" parceiros list-group-item list-group-item-action bg-light"><i class="fas fa-user-friends"></i> Parcerias</a>
        ...
        <a href="#" class=" ver-pedidos list-group-item list-group-item-action bg-light "><i class="fas fa-hands-helping"></i> Pedidos de Parceria</a>
