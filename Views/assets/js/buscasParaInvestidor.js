            ...
            success:function(Pedidos){
                ...
                for(pedido in Pedidos){
                    ...
                    <div class="pedidos row">
                        <div class="col-4"><img  class=" pequena img-projeto-dados rounded"src="${Pedidos[pedido].imagem}" alt="..." class="img-thumbnail"></div>
                        <div class="col-4 inline"> Nome: ${Pedidos[pedido].nome} <br> Área atuacao: ${Pedidos[pedido].areaatuacao}</div>
                        <div class ="col-2"><button type="button" class=" aceitar botao btn btn-success">Aceitar</button> </div>
                    ...
                    $('.aceitar').click(function(){
                        ...
                        $.ajax({
                            method:"POST",
                            url:"../Controladores/aceitarPedidodeParceria.php",
                            data:{id:identificador},
                            success:function(){
                                $(cont).parents('.tirar').fadeOut(1000);
                            },
                            error:function(){
